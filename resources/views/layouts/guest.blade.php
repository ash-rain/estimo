...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex">
        ...
        <div
            class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 p-12 flex-col justify-between">
            <div>
            ...
            <div class="text-white">
                ...
                <p class="text-lg text-indigo-100">Create accurate estimates, manage clients, and grow your business
                    with our powerful software.</p>

                <div class="mt-12 space-y-4">
                    <div class="flex items-start space-x-3">
                        <svg class="w-6 h-6 text-indigo-200 flex-shrink-0 mt-1" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
