                        ...
                        <div class="grid grid-cols-2 gap-6 mb-6">
                            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                                ...
                                <p class="text-xs text-gray-500">
                                    {{ $previousRevision->created_at->format('M d, Y - H:i') }}</p>
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                ...
                                <p class="text-xs text-gray-500">
                                    {{ $currentRevision->created_at->format('M d, Y - H:i') }}</p>
                        ...
                        @else
                            ...
                            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <p class="text-sm text-blue-700">
                                    {{ $currentRevision->getChangeSummary($previousRevision) }}</p>
                            </div>
                                    ...
                                    <div class="border rounded-lg p-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div class="bg-red-50 border border-red-200 rounded p-3">
                                                ...
                                                <p class="text-lg font-semibold text-red-700">
                                                    ${{ number_format($changes['total']['from'], 2) }}</p>
                                            </div>
                                            <div class="bg-green-50 border border-green-200 rounded p-3">
                                                <p class="text-xs text-gray-600 mb-1">New Total</p>
                                                <p class="text-lg font-semibold text-green-700">
                                                    ${{ number_format($changes['total']['to'], 2) }}</p>
                                            </div>
                                        </div>
                                        <div class="mt-3 text-center">
                                            <p class="text-sm">
                                                ...
                                                <span
                                                    class="{{ $changes['total']['diff'] > 0 ? 'text-green-600' : 'text-red-600' }} font-semibold">
                                ...
                                @if (isset($changes['items']))
                                    <div class="border rounded-lg p-4">
                                        ...
                                        @if (!empty($changes['items']['added']))
                                            <div class="mb-4">
                                                <h5
                                                    class="text-xs font-semibold text-green-800 uppercase mb-2 flex items-center">
                                        ...
                                        @if (!empty($changes['items']['removed']))
                                            <div class="mb-4">
                                                <h5
                                                    class="text-xs font-semibold text-red-800 uppercase mb-2 flex items-center">
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        @if (!empty($changes['items']['modified']))
                                            <div>
                                                <h5
                                                    class="text-xs font-semibold text-blue-800 uppercase mb-2 flex items-center">
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                    ...
                                                    @foreach ($changes['items']['modified'] as $modified)
                                                        <div class="bg-blue-50 border border-blue-200 rounded p-3">
                                                            <p class="text-sm font-medium text-gray-900 mb-2">
                                                                {{ $modified['item']['name'] }}</p>
                                                            <div class="space-y-1">
                                                                @if (isset($modified['changes']['quantity']))
                                                                    <p class="text-xs">
                                                                        <span class="text-gray-600">Quantity:</span>
                                                                        <span
                                                                            class="text-red-600 line-through ml-1">{{ $modified['changes']['quantity']['from'] }}</span>
                                                                        <span class="mx-1">→</span>
                                                                        <span
                                                                            class="text-green-600 font-medium">{{ $modified['changes']['quantity']['to'] }}</span>
                                                                    </p>
                                                                @endif
                                                                @if (isset($modified['changes']['unit_price']))
                                                                    <p class="text-xs">
                                                                        ...
                                                                        <span
                                                                            class="text-red-600 line-through ml-1">${{ number_format($modified['changes']['unit_price']['from'], 2) }}</span>
                                                                        <span class="mx-1">→</span>
                                                                        <span
                                                                            class="text-green-600 font-medium">${{ number_format($modified['changes']['unit_price']['to'], 2) }}</span>
                                                                    </p>
                                                                @endif
                                                            </div>
                                                        </div>
