                    ...
                    <div>
                        ...
                        @if ($revisions->isEmpty())
                            <div class="text-center py-12">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Create your first revision to start tracking
                                    changes.</p>
                            </div>
                        @else
                            <div class="grid grid-cols-1 gap-4">
                                @foreach ($revisions as $revision)
                                    <div
                                        class="border rounded-lg p-4 hover:bg-gray-50 transition-colors @if ($selectedRevisionId === $revision->id) ring-2 ring-indigo-500 @endif">
                                        <div class="flex items-start justify-between">
                                                                ...
                                                                <dl class="space-y-1">
                                                                    <div class="flex justify-between text-sm">
                                                                        ...
                                                                        <dd class="font-medium">
                                                                            ${{ number_format($revision->totals['subtotal'], 2) }}
                                                                        </dd>
                                                                    </div>
                                                                    <div class="flex justify-between text-sm">
                                                                        <dt class="text-gray-600">Tax:</dt>
                                                                        <dd class="font-medium">
                                                                            ${{ number_format($revision->totals['tax'], 2) }}
                                                                        </dd>
                                                                    </div>
                                                                    <div class="flex justify-between text-sm">
                                                                        <dt class="text-gray-600">Discount:</dt>
                                                                        <dd class="font-medium">
                                                                            ${{ number_format($revision->totals['discount'], 2) }}
                                                                        </dd>
                                                                    </div>
                                                                    <div
                                                                        class="flex justify-between text-sm font-semibold border-t pt-1">
                                                                        <dt class="text-gray-900">Total:</dt>
                                                                        <dd class="text-indigo-600">
                                                                            ${{ number_format($revision->totals['total'], 2) }}
                                                                        </dd>
                                                                    </div>
                                                                </dl>
                                                            </div>
                                            ...
                                            <div class="ml-4 flex flex-col space-y-2">
                                                <button wire:click="selectRevision({{ $revision->id }})"
