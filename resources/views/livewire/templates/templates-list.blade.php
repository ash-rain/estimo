<div class="p-6">
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('templates.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
            Create Template
        </a>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-center">
                <label class="flex items-center">
                    <input 
                        type="checkbox" 
                        wire:model.live="showIndustryPresets"
            ...
            <div class="flex items-center">
                <label class="flex items-center">
                    <input 
                        type="checkbox" 
                        wire:model.live="showUserTemplates"
                        class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    >
                    ...
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1">
                            ...
                            @if($template->category)
                                <span class="inline-block px-2 py-1 text-xs font-medium text-indigo-700 bg-indigo-100 rounded mt-1">
