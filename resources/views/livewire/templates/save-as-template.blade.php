                ...
                <div class="relative inline-block w-full max-w-lg p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                    ...
                    <form wire:submit.prevent="saveTemplate">
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="valid_until_days" class="block text-sm font-medium text-gray-700">Default Valid Until (days)*</label>
                                <input 
                                    type="number" 
                                    id="valid_until_days"
                                    wire:model="valid_until_days"
                                    min="1"
                                    max="365"
                                    class="mt-1 block w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                                    required
                                >
                                @error('valid_until_days') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                            </div>
