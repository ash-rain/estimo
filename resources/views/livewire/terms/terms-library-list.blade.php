            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($terms as $term)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @if($term->category)
                                <span class="inline-block px-2 py-1 text-xs font-medium text-indigo-700 bg-indigo-100 rounded">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                            <button 
                                wire:click="openEditModal({{ $term->id }})"
                                class="text-indigo-600 hover:text-indigo-900"
                            >
                                Edit
                            </button>
                            <button 
                                wire:click="duplicateTerm({{ $term->id }})"
                    ...
                    <form wire:submit.prevent="saveTerm">
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="termCategory" class="block text-sm font-medium text-gray-700">Category</label>
                                    <select 
                                        id="termCategory"
                                        wire:model="termCategory"
                                        class="mt-1 block w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                                    >
                                    ...
                                    @error('termCategory') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
                                </div>
