<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Upload a CSV file to bulk import catalog items. Download the template to see the required format.</p>
    </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <label class="flex-1 flex flex-col items-center px-4 py-6 bg-white border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:bg-gray-50">
                ...
                <div class="flex gap-3">
                    <button
                        type="submit"
                        :disabled="!$wire.file || $wire.importing"
        ...
        <div class="space-y-4">
            ...
            @if (!empty($importResults['errors']))
                <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                    <h4 class="text-sm font-medium text-red-900 mb-2">Errors ({{ count($importResults['errors']) }}):</h4>
            ...
            <div class="flex gap-3">
                ...
                <button
                    type="button"
                    onclick="window.dispatchEvent(new CustomEvent('import-completed'))"
